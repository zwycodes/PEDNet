...
class Trainer(object):
    ...
    def train_epoch(self):
        ...
        for batch_id, inputs in enumerate(self.train_iter, 1):  
            ...
            if batch_id % self.log_steps == 0:
                message_prefix = "[Train][{:2d}][{}/{}-task:{}]".format(self.epoch, batch_id, num_batches,task_id)
    ...
    def train(self):
        ...
        for _ in range(self.epoch, self.num_epochs):
            self.train_epoch()  # self.epoch初始值等于0
    ...
    def save(self, is_best=False):
        ...
        train_state = {"epoch": self.epoch,
                       ...
                       # "current_step": self.optimizer.n_current_steps
        if self.lr_scheduler is not None:
    ...
    def load(self, file_prefix):
        ...
        # self.optimizer.n_current_steps = train_state_dict["current_step"]
...
def write_results(results, results_file):
    ...
    with open(results_file, "w", encoding="utf-8") as f:
        for result in results:
            ...
            """
            topic_logit = result.topic_proab
